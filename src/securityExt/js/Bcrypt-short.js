...
fan.securityExt.Bcrypt.prototype.hashPw = function(password, salt, callback, progress) { this.m_bcrypt.hashpw(password, salt, callback.m_func, progress != null ? progress.m_func : null ); }
